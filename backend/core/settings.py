"""
Django settings for dtailbase project.
...
CORS_ALLOWED_ORIGINS = [
    origin for origin in env_list(
        'CORS_ALLOWED_ORIGINS',
        'https://187.124.208.220,https://dtailbase.com,https://www.dtailbase.com,http://localhost:5173'
    )
]
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@dtailbase.com')
