...
class PayFastCheckoutView(APIView):
    domain = "https://" + os.environ.get('RENDER_EXTERNAL_HOSTNAME', 'your-ngrok-url.app')
    ...
    def post(self, request):
        ...
        payfast_data = {
            ...
            'amount': f"{amount:.2f}",
            'item_name': f"DetailerFlow {plan_id} Subscription",
        ...
        for key, value in payfast_data.items():
            if value:
                # quote_plus turns "DetailerFlow PRO" into "DetailerFlow+PRO"
        ...
        # item_name=DetailerFlow+PRO+Subscription
