  ...
  const sections = [
    {
      ...
      content: "By using DetailerFlow, you agree to our cloud service terms. We provide a platform for studio management, and users are responsible for the accuracy of the data entered into the system."
    },
    {
      id: "privacy",
    ...
    },
    {
      ...
      content: "You own your data. Should you choose to leave DetailerFlow, you can export your customer lists and service history in CSV format at any time."
    },
    {
      id: "liability",
      title: "Limitation of Liability",
      content: "DetailerFlow is a management tool. While we provide digital indemnity forms, the legal validity of signed waivers remains the responsibility of the studio owner under local South African law."
    }
  ];
